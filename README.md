...
* <a href="#Начало">Начало</a>
  + <a href="#Управление_плеером">Управление плеером</a>
  + <a href="#Функции_управления_видео_контентом">Функции управления видео-контентом</a>
* <a href="#testing">Testing</a>

### [Начало](#Начало)
Основным рабочим файлом является ads.js в папке js. Для воспроизведения рекламы используется GOOGLE IMA SDK.

### [Управление плеером](#Управление_плеером)
...
### [Функции управления видео-контентом](#Функции_управления_видео_контентом)
